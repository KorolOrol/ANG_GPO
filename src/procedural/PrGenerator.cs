...
public class PrGenerator
{
    ...
    public void CreateByChaoticRandomTraits(PrCharacter character, int traits_count)
    {
    ...
    /// </summary>
    /// <param name="traits_count"></param>
    public void CreateByLogicRandomTraits(PrCharacter character, int traits_count)
    {
        if (GlobalData._MaxPossibleTraits < traits_count)
        {
    ...
    public void CreateByTwoParentsHalfRandomTraits(PrCharacter character, int traits_count, PrCharacter mama, PrCharacter papa, string name)
    {
        if (GlobalData._MaxPossibleTraits < traits_count)
        {
    ...
    /// <param name="papa"></param>
    /// <param name="name"></param>
    public void CreateByTwoParentsHalfTraits(PrCharacter character, PrCharacter mama, PrCharacter papa, string name)
    {
        if (mama.Traits == null || papa.Traits == null)
        {
            Console.WriteLine("У Мамы и/или Папы нет черт");
    ...
    /// <param name="papa"></param>
    /// <param name="name"></param>
    public void CreateByTwoParentsLogicRandomTraits(PrCharacter character, int traits_count, PrCharacter mama, PrCharacter papa, string name) // Разветвление добавить (конструктор)
    {
        character.Name = name;
    ...
    /// <param name="papa"></param>
    /// <param name="name"></param>
    public void CreateByTwoParentsLogicTraits(PrCharacter character, PrCharacter mama, PrCharacter papa, string name)
    {
        if (mama.Traits == null || papa.Traits == null)
        {
            Console.WriteLine("У Мамы и/или Папы нет черт");
    ...
    /// <param name="traits_count"></param>
    public void CreateByInputTrait(PrCharacter character, string trait_name, int traits_count)
    {
        if (GlobalData._MaxPossibleTraits < traits_count)
        {
    ...
    /// <param name="traits_count"></param>
    public void CreateByInputTraits(PrCharacter character, List<string> traits_names, int traits_count)
    {
        if (GlobalData._MaxPossibleTraits < traits_count)
        {
            Console.WriteLine("Недостаточно черт в базе данных для CreateByInputTrait");
    ...
    public void CreateByChaoticRandomPhobias(PrCharacter character, int phobias_count)
    {
    ...
    /// <param name="i"></param>
    /// <returns></returns>
    private bool CheckTabl(PrCharacter character, int i)
    {
    ...
    /// </summary>
    private void CreateDesc(PrCharacter character)
    {
    ...
    /// </summary>
    /// <param name="a"></param>
    public void GetRelations(PrCharacter character, PrCharacter opponent)
    {
        if (opponent == null)
        {
